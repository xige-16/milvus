...
func (t *searchTask) Requery() error {
	...
	return doRequery(t.ctx, t.GetCollectionID(), t.node, t.schema, queryReq, t.result)
}
...
func doRequery(ctx context.Context,
	...
	result *milvuspb.SearchResults) error {
	...
	result.Results.FieldsData = lo.Filter(result.Results.FieldsData, func(fieldData *schemapb.FieldData, i int) bool {
		return lo.Contains(qt.request.GetOutputFields(), fieldData.GetFieldName())
	})
