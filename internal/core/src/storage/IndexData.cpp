...
IndexData::serialize_to_remote_file() {
    ...
    auto& insert_event_data = index_event.event_data;
    ...
    auto& insert_event_header = index_event.event_header;
    insert_event_header.event_type_ = EventType::IndexFileEvent;
    // TODO :: set timestamps
    ...
    des_fix_part.partition_id = field_data_meta_->collection_id;
    des_fix_part.segment_id = field_data_meta_->collection_id;
    des_fix_part.field_id = field_data_meta_->collection_id;
    ...
    des_event_data.extras[BINLOG_FILE_KEY] = index_meta_->key;
