...
private:
    ...
    MinioChunkManager& operator = (const MinioChunkManager &);
...
public:
    ...
    GetInstance() {
        ...
        static MinioChunkManager instance(config::ChunkMangerConfig::GetAddress(),
                                          config::ChunkMangerConfig::GetAccessKey(),
                                          config::ChunkMangerConfig::GetAccessValue(),
                                          config::ChunkMangerConfig::GetBucketName(),
