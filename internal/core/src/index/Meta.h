...
//// index meta
// constexpr const char* SLICE_SIZE = knowhere::meta::SLICE_SIZE;
// constexpr const char* DIM = knowhere::meta::DIM;
// constexpr const char* TOPK = knowhere::meta::TOPK;
//

//// IVF params
// constexpr const char* NPROBE = knowhere::indexparam::NPROBE;
// constexpr const char* NLIST = knowhere::indexparam::NLIST;
// constexpr const char* M = knowhere::indexparam::M;
// constexpr const char* NBITS = knowhere::indexparam::NBITS;
//
//// PQ params
// constexpr const char* PQ_M = knowhere::indexparam::PQ_M;
//
//// HNSW params
// constexpr const char* EFCONSTRUCTION = knowhere::indexparam::EFCONSTRUCTION;
// constexpr const char* HNSW_M = knowhere::indexparam::HNSW_M;
// constexpr const char* EF = knowhere::indexparam::EF;
//
//// Annoy params
// constexpr const char* N_TREES = knowhere::indexparam::N_TREES;
// constexpr const char* SEARCH_K = knowhere::indexparam::SEARCH_K;
