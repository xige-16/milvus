...
CreateIndexV2(CIndex* res_index, CBuildIndexInfo c_build_index_info) {
    try {
        ...
        milvus::proto::indexcgo::TypeParams type_params;
        milvus::proto::indexcgo::IndexParams index_params;
        milvus::index::ParseFromString(type_params, build_index_info->serialized_type_params);
        milvus::index::ParseFromString(index_params, build_index_info->serialized_index_params);
...
CStatus
AppendBuildIndexParam(CBuildIndexInfo c_build_index_info, const char* c_serialized_index_params) {
    try {
        auto build_index_info = (BuildIndexInfo*)c_build_index_info;
        build_index_info->serialized_index_params = std::string(c_serialized_index_params);
...
CStatus
AppendBuildTypeParam(CBuildIndexInfo c_build_index_info, const char* c_serialized_type_params) {
    try {
        auto build_index_info = (BuildIndexInfo*)c_build_index_info;
        build_index_info->serialized_type_params = std::string(c_serialized_type_params);
